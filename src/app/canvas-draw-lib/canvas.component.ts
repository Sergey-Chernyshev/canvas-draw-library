...
import { PolygonsService } from './services/element/polygons.service';
...
export class CanvasComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    this.#canvasService.canvasRef = this.canvasRef;
    ...
    this.#canvasZoomService.initializePan();
      const rectangleVertices = [
          { x: 100, y: 100 }, // Верхняя левая
          { x: 300, y: 100 }, // Верхняя правая
          { x: 300, y: 200 }, // Нижняя правая
          { x: 100, y: 200 }, // Нижняя левая
          { x: 200, y: 250 }, // Дополнительная вершина
          { x: 50, y: 150 }   // Дополнительная вершина
      ];

      const triangleVertices = [
          { x: 400, y: 100 }, // Вершина 1
          { x: 500, y: 300 }, // Вершина 2
          { x: 300, y: 300 }  // Вершина 3
      ];

      const pentagonVertices = [
          { x: 600, y: 100 },  // Вершина 1
          { x: 700, y: 150 },  // Вершина 2
          { x: 650, y: 250 },  // Вершина 3
          { x: 550, y: 250 },  // Вершина 4
          { x: 500, y: 150 }   // Вершина 5
      ];
  ...
  // private scaleFactor = 1.03; // Фактор масштабирования при зуме
  //
  ...
  // private drawVertices(polygon: { x: number; y: number }[], color = 'black'): void {
