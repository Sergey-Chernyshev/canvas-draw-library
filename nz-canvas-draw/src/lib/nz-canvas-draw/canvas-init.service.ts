...
import { CanvasSettings } from './canvas-settings/canvas-settings.interface';
...
export class CanvasInitService {
    ...
    initCanvas(canvasRef: ElementRef<HTMLCanvasElement>, canvasSettings?: Partial<CanvasSettings>) {
